...
void OneWireAnalyzerResults::GenerateExportFile( const char* file, DisplayBase display_base, U32 /*export_type_user_id*/ )
{
    ...
    for( U32 i = 0; i < num_frames; i++ )
    {
        ...
        case SearchRomFrame:
        {
            ss << "Search Rom Command"
               << ", " << number_str;
        }
        break;
        case AlarmSearchFrame:
        {
            ss << "Alarm Search Rom Command"
               << ", " << number_str;
        }
        break;
        case MatchRomFrame:
        {
            ss << "Match Rom Command"
               << ", " << number_str;
        }
        break;
        case OverdriveSkipRomFrame:
        {
            ss << "Overdrive Skip Rom Command"
               << ", " << number_str;
        }
        break;
        case OverdriveMatchRomFrame:
        {
            ss << "Overdrive Match Rom Command"
               << ", " << number_str;
        }
        break;
        case CRC:
...
void OneWireAnalyzerResults::GeneratePacketTabularText( U64 /*packet_id*/,
                                                        DisplayBase /*display_base*/ ) // unrefereced vars commented out to remove warnings.
{
    ClearResultStrings();
...
void OneWireAnalyzerResults::GenerateTransactionTabularText(
